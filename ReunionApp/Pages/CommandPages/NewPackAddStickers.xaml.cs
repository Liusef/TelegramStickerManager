...
/// </summary>
public sealed partial class NewPackAddStickers : Page
{
    private StickerPack pack;
    private Button backButton;
    private ObservableCollection<NewSticker> stickers = new ObservableCollection<NewSticker>();

    public record NewPackAddStickersParams(StickerPack pack, Button back);

    public NewPackAddStickers()
    {
    ...
    protected override void OnNavigatedTo(NavigationEventArgs e)
    {
        ...
        var p = e.Parameter as NewPackAddStickersParams;
        if (p != null)
        {
            pack = p.pack;
            backButton = p.back;
    ...
    private async void Finish(object sender, RoutedEventArgs e)
    {
        ...
        var runner = new NewPackRunner(pack, stickers.ToArray());
